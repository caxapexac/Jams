function particles_init(sprite_source, subsprite_scale, max_count) {
    ...
    if (!variable_instance_exists(id, "particles_displacement_min_x")) particles_displacement_min_x = 0;
    if (!variable_instance_exists(id, "particles_displacement_max_x")) particles_displacement_max_x = 0;
    if (!variable_instance_exists(id, "particles_displacement_min_y")) particles_displacement_min_y = 0;
    if (!variable_instance_exists(id, "particles_displacement_max_y")) particles_displacement_max_y = 0;
