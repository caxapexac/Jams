...
function create_particle(free_index) {
    ...
    particles_arr_x[free_index] = x + random_range(particles_displacement_min_x, particles_displacement_max_x);
    particles_arr_y[free_index] = y + random_range(particles_displacement_min_y, particles_displacement_max_y);
    
    particles_arr_lifetime[free_index] = random_range(particles_lifetime_min * room_speed, particles_lifetime_max * room_speed);
    ...
    particles_arr_speed_start_y[free_index] = random_range(particles_speed_start_min_y, particles_speed_start_max_y)
