function particles_init(sprite_source, subsprite_scale, max_count) {
    ...
    if (!variable_instance_exists(id, "particles_lifetime_max")) particles_lifetime_max = 2 * room_speed;
    if (!variable_instance_exists(id, "particles_lifetime_min")) particles_lifetime_min = 1 * room_speed;
