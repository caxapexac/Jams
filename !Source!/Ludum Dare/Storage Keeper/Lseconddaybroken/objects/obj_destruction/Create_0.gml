...
parts_random_scale = array_create(parts_count, 0);
...
for (var i = 0; i < parts_count; i++) {
    ...
    parts_speed_x[i] = random_range(-parts_start_speed_x, parts_start_speed_x);
    parts_speed_y[i] = random_range(-parts_start_speed_y, parts_start_speed_y);
    ...
    parts_random_scale[i] = random_range(0, parts_random_scale_multipiler)
}
